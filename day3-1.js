...
function move(from, movement) {
	switch(movement.direction) {
		case 'U': return {...from, y: parseInt(from.y) + parseInt(movement.distance)}
			break;
		case 'D': return {...from, y: parseInt(from.y) - parseInt(movement.distance)}
			break;
		case 'L': return {...from, x: parseInt(from.x) - parseInt(movement.distance)}
			break;
		case 'R': return {...from, x: parseInt(from.x) + parseInt(movement.distance)}
			break;
...
function getIntersections(array1, array2) {
	return intersect([array1, array2], JSON.stringify)
}
